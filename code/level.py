    ...
    def create_map(self):
        layout_files = {
            'Easy': {
                ...
                'grass': 'map/map_Grass_Easy.csv',
                'object': 'map/map_Objects_Easy.csv',
                'entities': 'map/map_Entities_Easy.csv'
            },
            'Normal': {
                'boundary': 'map/map_FloorBlocks.csv',
                'grass': 'map/map_Grass_Normal.csv',
                'object': 'map/map_Objects_Normal.csv',
                'entities': 'map/map_Entities_Normal.csv'
            },
            'Hard': {
                'boundary': 'map/map_FloorBlocks.csv',
                'grass': 'map/map_Grass_Hard.csv',
                'object': 'map/map_Objects_Hard.csv',
                'entities': 'map/map_Entities_Hard.csv'
            }
        }
        graphics = {
        ...
        selected_layouts = layout_files[self.difficulty]

        for style, file_path in selected_layouts.items():
            layout = import_csv_layout(file_path)
