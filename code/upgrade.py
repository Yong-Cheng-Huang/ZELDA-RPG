...
class Upgrade:
    ...
    def input(self):
        ...
        if self.can_move:
            if keys[pygame.K_RIGHT] and self.selection_index < self.attribute_nr - 1:
                pygame.mixer.music.load("audio/select.mp3")
    ...
    def display_upgrade_prompt(self):
        prompt_text = "Press Space to Upgrade"
        font = pygame.font.Font(UI_FONT, UI_FONT_SIZE)
        text_surface = font.render(
            prompt_text, True, (255, 255, 255))  # White color text
        text_rect = text_surface.get_rect(center=(
            self.display_surface.get_width() // 2, self.display_surface.get_height() - 20))
...
class Item:
    ...
    def trigger(self, player):
        ...
        if player.exp >= player.upgrade_cost[upgrade_attribute] and player.stats[upgrade_attribute] < player.max_stats[upgrade_attribute]:
            ...
            pygame.mixer.music.load("audio/upgrade.mp3")
